...
global.owner = process.env.OWNER_NUMBER  || '94714774537' ;  // ADD YOUR NUMBER WITHOUT +
    
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || '3NkCwAIB#WyFNixg_bRZPjXlz31jRJW19g8Z_zo_wbbxwVyuo1Sc' ,
